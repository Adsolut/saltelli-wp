...
## Current state — v1.3.21-chore-batch3-followups (CUT-READY)

**Last updated:** 2026-05-12 (Chore Batch 3 follow-ups: fix leftover #18 helper `saltelli_tier_badge_label()` applicato anche a `taxonomy-tipo-area.php:361` (uniforma label "Approfondimento" su 3 term pages) + nota EDITOR-HANDOFF Page 2714 2-metabox transizione Wave J. Prev: chore housekeeping post-Batch 3: CSS dead-code cleanup `.sl-tier1__*` 71 rule rimosse + 13 SCF orphan field documentati in `docs/SCF_ORPHAN_FIELDS.md` + 18 prompts recovery archived + 5 prompts obsolete archived.)
**Branch:** `main` · last merge `17930e8` (chore batch3 follow-ups v1.3.21) · prev merge `66231b7` (chore housekeeping post-batch3 v1.3.20) · prev merge `e466e1f` (Wave J prenota=richiedi v1.3.19) · ~42 commit totali post-v1.3.13
