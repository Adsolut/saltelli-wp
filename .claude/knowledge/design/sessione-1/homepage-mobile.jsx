  ...
  return (
    <div className="sl-root" ref={scrollRef} style={{ height: 812, width: 375, overflowY: "auto", overflowX: "hidden", position: "relative", margin: "0 auto" }}>
      ...
      <header style={{
        ...
        <div style={{ fontFamily: "var(--font-display)", fontSize: 17, color: "var(--primary)", letterSpacing: "-0.01em", lineHeight: 1.1 }}>
          Saltelli &amp; Partners
        </div>
      ...
      <footer style={{ background: "var(--primary)", color: "var(--background)", padding: "48px 20px 24px" }}>
        <div style={{ fontFamily: "var(--font-display)", fontSize: 24, marginBottom: 24, lineHeight: 1.1 }}>
