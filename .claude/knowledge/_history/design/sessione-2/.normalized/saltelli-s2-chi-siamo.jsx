...
function S2ChiSiamo() {
  ...
  const timeline = [
    ...
    { y: "2019", t: "Vent'anni", d: "Lo studio passa da 2 a 4 professionisti stabili. Atelier a tutti gli effetti." },
    { y: "2024", t: "Cassazione + AGE", d: "Annullamento cartella €240k. Conferma in Cassazione su licenziamento illegittimo." },
    { y: "2026", t: "Oggi", d: "19 aree presidiate, 4 professionisti, un solo atelier." },
  ];
      ...
      <section style={{ maxWidth: 1440, margin: "0 auto", padding: "0 clamp(24px, 5vw, 96px) 128px" }}>
        <div style={{
          ...
          <div style={{
            ...
            background: "linear-gradient(180deg, var(--border) 0%, color-mix(in srgb, var(--text-muted) 75%, transparent) 60%, var(--text-muted) 100%)",
            opacity: 0.55,
          }} />
      ...
      <section style={{ maxWidth: 1440, margin: "0 auto", padding: "0 clamp(24px, 5vw, 96px) 128px", display: "grid", gridTemplateColumns: "3fr 7fr 2fr", gap: 64 }}>
        ...
        <div>
          <h2 style={{ fontSize: "clamp(32px, 3.5vw, 48px)", marginBottom: 32, letterSpacing: "-0.015em" }}>
            Un atelier, in senso napoletano.
          </h2>
          <div style={{ fontSize: 18, lineHeight: 1.75, color: "var(--text)", display: "grid", gap: 20, maxWidth: "62ch" }}>
            ...
            <p>
              ...
              paziente, una pratica alla volta, un avvocato alla volta — fino a diventare oggi un atelier di
          ...
          <div>
            ...
            <div style={{ display: "grid", gap: 0 }}>
              {[
                ...
                { n: "02", t: "Lavoriamo in atelier", d: "Ogni pratica è seguita personalmente da uno dei quattro avvocati. Niente call center, niente passaggi." },
