    ...
    <div className="sl-root">
      ...
      <section style={{
        ...
        <a href="#" style={{
          ...
          <div style={{
            aspectRatio: "16 / 9",
            background: "linear-gradient(135deg, color-mix(in srgb, var(--text-muted) 35%, var(--surface)) 0%, color-mix(in srgb, var(--text) 90%, transparent) 100%)",
    ...
    <a href="#"
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: "linear-gradient(135deg, color-mix(in srgb, var(--text-muted) 50%, transparent) 0%, color-mix(in srgb, var(--text) 75%, transparent) 100%)",
