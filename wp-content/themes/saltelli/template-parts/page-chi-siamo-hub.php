...
<section class="sl-page-hero sl-hub-hero" aria-labelledby="hub-chi-siamo-h1">
    <div class="sl-container sl-hub-hero__inner">
        ...
        <p class="sl-mono sl-hub-hero__eyebrow"><?php esc_html_e('§ Chi siamo', 'saltelli'); ?></p>
        <h1 class="sl-page__title sl-hub-hero__h1" id="hub-chi-siamo-h1" data-split-reveal>
            <?php
            $sl_h1 = esc_html__('Quattro avvocati,', 'saltelli') . '<br>'
                . '<em>' . esc_html__('un atelier.', 'saltelli') . '</em>';
        ...
        <p class="sl-page__lede sl-hub-hero__lede">
            <?php esc_html_e("Studio Legale Emiliano Saltelli & Partners. Quattro professionisti in Via Vannella Gaetani, Chiaia. Una bottega — non una catena. Dal 1999.", 'saltelli'); ?>
        </p>
    </div>
</section>
...
<section class="sl-hub-grid-section" aria-label="<?php esc_attr_e('Sezioni Chi Siamo', 'saltelli'); ?>">
    <div class="sl-container">
        <ul class="sl-hub-grid sl-hub-grid--3">
            ...
            <li class="sl-hub-card">
                <a class="sl-hub-card__link" href="<?php echo esc_url(home_url('/chi-siamo/risultati/')); ?>">
